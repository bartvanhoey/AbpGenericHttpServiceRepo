...
namespace BookStoreAbpApi.Blazor.Client.Pages.Authors;
...
public partial class Authors
{
    ...
    private async Task SetPermissionsAsync()
    {
        CanCreateAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpApiPermissions.Authors.Create);

        CanEditAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpApiPermissions.Authors.Update);

        CanDeleteAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpApiPermissions.Authors.Delete);
    }
    ...
    {
        var confirmMessage = L["AuthorDeletionConfirmationMessage", author.Name ?? string.Empty];
