...
{
    [DbContext(typeof(BookStoreAbpApiDbContext))]
    [Migration("20240707060243_AuthorIdToBookAdded")]
    partial class AuthorIdToBookAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreAbpApi.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BookStoreAbpApi.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStoreAbpApi.Books.Book", b =>
                {
                    b.HasOne("BookStoreAbpApi.Authors.Author", null)
                        .WithMany()
